...
gisbase = "/Applications/GRASS-7.4svn.app/Contents/MacOS"
...
RHESSysPreprocessing::RHESSysPreprocess(
  template=template,
  name=name,
  type=type,
  typepars=typepars,
