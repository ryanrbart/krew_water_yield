...
x <- filter(p301_shed_diff, var_type == "streamflow") %>%
  ...
  NULL
print(x)
ggsave("output/3.5_simulations/precip_vs_change_in_q2.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff, var_type == "et") %>%
  ...
  NULL
print(x)
ggsave("output/3.5_simulations/precip_vs_change_in_et2.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff, var_type == "trans") %>%
  ...
  NULL
print(x)
ggsave("output/3.5_simulations/precip_vs_change_in_trans2.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff, var_type == "evap") %>%
  ...
  NULL
print(x)
ggsave("output/3.5_simulations/precip_vs_change_in_evap2.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff_avg, var_type == "rz_storage") %>%
  ...
  NULL
print(x)
ggsave("output/3.5_simulations/precip_vs_change_in_rz_storage2.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff_avg, var_type == "sat_def") %>%
  ...
  NULL
print(x)
ggsave("output/3.5_simulations/precip_vs_change_in_sat_def2.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff_avg, var_type == "unsat_stor") %>%
  ...
  NULL
print(x)
ggsave("output/3.5_simulations/precip_vs_change_in_unsat_stor2.jpg", plot=x, width = 6, height = 4)
