...
out_mcmc_mam7 <- MCMCglmm(log(q_treated) ~ q_control_log_center + treatment,
...
out_mcmc_q95 <- MCMCglmm(log(q_treated) ~ q_control_log_center + treatment,
                          random = ~ us(1+q_control_log_center):shed_treated,
                          nitt = n_runs, thin = 20, burnin = 20000,
...
out_mcmc_seasonal_1 <- MCMCglmm(log(q_treated) ~ q_control_log_center + treatment,
                              random = ~ us(1+q_control_log_center):shed_treated,
                              nitt = n_runs, thin = 20, burnin = 20000,
...
out_mcmc_seasonal_2 <- MCMCglmm(log(q_treated) ~ q_control_log_center + treatment,
                                random = ~ us(1+q_control_log_center):shed_treated,
                                nitt = n_runs, thin = 20, burnin = 20000,
...
out_mcmc_seasonal_3 <- MCMCglmm(log(q_treated) ~ q_control_log_center + treatment,
                                random = ~ us(1+q_control_log_center):shed_treated,
                                nitt = n_runs, thin = 20, burnin = 20000,
...
out_mcmc_seasonal_4 <- MCMCglmm(log(q_treated) ~ q_control_log_center + treatment,
                                random = ~ us(1+q_control_log_center):shed_treated,
                                nitt = n_runs, thin = 20, burnin = 20000,
...
out_mcmc_wy <- MCMCglmm(log(q_treated) ~ q_control_log_center + treatment,
                        random = ~ us(1+q_control_log_center):shed_treated,
                        nitt = n_runs, thin = 20, burnin = 20000,
