...
input_rhessys$world_file <- "ws_p301_test/worldfiles/p301_spinup_pre.world"
input_rhessys$world_hdr_prefix <- "p301_spinup"
input_rhessys$flow_file <- "ws_p301_test/flowtables/p301.flow"
input_rhessys$start_date <- "1941 10 1 1"
#input_rhessys$end_date <- "2041 10 1 1"
input_rhessys$end_date <- "1947 10 1 1"
input_rhessys$output_folder <- "ws_p301_test/out/3.1_p301_spinup"
...
input_rhessys$command_options <- c("-vegspinup ws_p301_test/tecfiles/spinup_thresholds_p301.txt -b -g -c 1 229 5103 5103 -p 1 229 5103 5103 -tchange 0 0")
...
#input_hdr_list$stratum_def <- c("ws_p301_test/defs/veg_p301_conifer.def")
input_hdr_list$stratum_def <- c("ws_p301_test/defs/veg_p301_conifer.def", "ws_p301_test/defs/veg_p301_shrub.def")
input_hdr_list$spinup_def <- c("ws_p301_test/defs/spinup_p301.def")
