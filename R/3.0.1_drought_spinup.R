...
input_rhessys$tec_file <- "ws_p301/tecfiles/p301_3.0.1_spinup.tec"
input_rhessys$world_file <- "ws_p301/worldfiles/p301_patch_5103.world"
input_rhessys$world_hdr_prefix <- "p301_3.0.1"
input_rhessys$flow_file <- "ws_p301/flowtables/p301_patch_5103.flow"
input_rhessys$start_date <- "1941 10 1 1"
input_rhessys$end_date <- "2141 10 1 1"
input_rhessys$output_folder <- "ws_p301/out/3.0.1_drought_calibration"
...
input_def_list <- list(
  ...
  list(input_hdr_list$stratum_def[1], "epc.gl_smax", c(0.002)),
  # -----
...
input_tec_data[3,] <- data.frame(2141, 9, 30, 1, "output_current_state", stringsAsFactors=FALSE)
