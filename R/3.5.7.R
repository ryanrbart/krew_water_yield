...
x <- filter(p301_shed_diff, var_type == "streamflow", wy=="1943") %>%
  ...
  NULL
print(x)
ggsave("output/3.5_simulations/precip_vs_change_in_q_year1.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff, var_type == "trans", wy=="1943") %>%
  ...
  NULL
print(x)
ggsave("output/3.5_simulations/precip_vs_change_in_trans_year1.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff, var_type == "streamflow", wy=="1943") %>%
  ...
  NULL
print(x)
ggsave("output/3.5_simulations/precip_vs_change_in_q2_year1.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff, var_type == "trans", wy=="1943") %>%
  ...
  NULL
print(x)
ggsave("output/3.5_simulations/precip_vs_change_in_trans2_year1.jpg", plot=x, width = 6, height = 4)
