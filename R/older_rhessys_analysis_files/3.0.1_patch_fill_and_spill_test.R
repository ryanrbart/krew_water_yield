...
input_rhessys$world_file <- "ws_p301/worldfiles/p301_patch_5103.Y2241M9D30H1.world"   #This was generated from 3.1.1
...
input_rhessys$end_date <- "1971 10 1 1"
input_rhessys$output_folder <- "ws_p301/out/3.0_fill_spill"
...
input_def_list <- list(
  ...
  list(input_hdr_list$soil_def[1], "fs_spill", c(2.0)),
  list(input_hdr_list$soil_def[1], "fs_percolation", c(2.0)),
  list(input_hdr_list$soil_def[1], "fs_threshold", c(2.0))
)
