...
# 
# This script is used to simulate vegetation at patch level.
...
input_rhessys$tec_file <- "ws_p300_patch/tecfiles/p300_patch_simulation.tec"
input_rhessys$world_file <- "ws_p300_patch/worldfiles/p300_30m_2can_patch_9445_test.world"
input_rhessys$world_hdr_prefix <- "p300_30m_2can_patch_9445"
input_rhessys$flow_file <- "ws_p300_patch/flowtables/p300_30m_patch_9445.flow"
input_rhessys$start_date <- "1941 10 1 1"
input_rhessys$end_date <- "1942 10 1 1"
input_rhessys$output_folder <- "ws_p300_patch/out/10_p300_patch_simulation"
...
# HDR (header) file
input_hdr_list <- list()
input_hdr_list$basin_def <- c("ws_p300_patch/defs/basin_p300.def")
input_hdr_list$hillslope_def <- c("ws_p300_patch/defs/hill_p300.def")
input_hdr_list$zone_def <- c("ws_p300_patch/defs/zone_p300.def")
input_hdr_list$soil_def <- c("ws_p300_patch/defs/patch_p300.def")
input_hdr_list$landuse_def <- c("ws_p300_patch/defs/lu_p300.def")
input_hdr_list$stratum_def <- c("ws_p300_patch/defs/veg_p300_conifer.def", "ws_p300_patch/defs/veg_p300_shrub.def")
input_hdr_list$base_stations <- c("ws_p300_patch/clim/Grove_lowprov_clim_1942_2453.base")
...
input_def_list <- list(
  ...
  list(input_hdr_list$zone_def[1], "lapse_rate_precip_default", c(-0.005, -0.0045,
                                                                  -0.004, -0.0035,
                                                                  -0.003, -0.0025,
                                                                  -0.002, -0.0015,
                                                                  -0.001, -0.0005,
...
#input_def_list[[12]] <- list(input_hdr_list$soil_def[1], "overstory_height_thresh", 3)
...
input_clim_base_list[[1]][[4]][1,] <- data.frame(c1="ws_p300_patch/clim/Grove_lowprov_clim_1942_2453", c2="daily_climate_prefix",stringsAsFactors=FALSE)
...
#input_tec_data[3,] <- data.frame(1951, 10, 1, 1, "output_current_state", stringsAsFactors=FALSE)
...
output_variables[3,] <- data.frame("streamflow", "awks/output_var_bd_streamflow.awk","patch_sim_basin.daily",stringsAsFactors=FALSE)
output_variables[4,] <- data.frame("precip", "awks/output_var_bd_precip.awk","patch_sim_basin.daily",stringsAsFactors=FALSE)
