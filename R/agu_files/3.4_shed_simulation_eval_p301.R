...
# 3m soil
p301_shed_diff_3m <- process_shed_diff(RHESSYS_ALLSIM_DIR_21_P301_3,
                                       RHESSYS_ALL_OPTION_21_P301_3)

# 5m soil
p301_shed_diff_5m <- process_shed_diff(RHESSYS_ALLSIM_DIR_21_P301_5,
                                       RHESSYS_ALL_OPTION_21_P301_5)
...
x <- filter(p301_shed_diff_avg, var_type == "rz_storage") %>%
  ...
  NULL
print(x)
ggsave("output/icrw_branch/precip_vs_change_in_rz_storage.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff_avg, var_type == "sat_def") %>%
  ...
  NULL
print(x)
ggsave("output/icrw_branch/precip_vs_change_in_sat_def.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff_avg, var_type == "unsat_stor") %>%
  ...
  NULL
print(x)
ggsave("output/icrw_branch/precip_vs_change_in_unsat_stor.jpg", plot=x, width = 6, height = 4)
