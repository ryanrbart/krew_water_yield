...
x <- filter(p301_shed_diff, var_type == "streamflow", wy=="1943") %>%
  ...
  NULL
print(x)
ggsave("output/icrw_branch/precip_vs_change_in_q_all.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff, var_type == "trans", wy=="1943") %>%
  ...
  NULL
print(x)
ggsave("output/icrw_branch/precip_vs_change_in_trans_all.jpg", plot=x, width = 6, height = 4)
...
x <- filter(p301_shed_diff, var_type == "evap", wy=="1943") %>%
  ...
  NULL
print(x)
ggsave("output/icrw_branch/precip_vs_change_in_evap_all.jpg", plot=x, width = 6, height = 4)
